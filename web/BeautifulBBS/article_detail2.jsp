...
<html>
<head>
    <title>Java|Java世界_中文论坛|ChinaJavaWorld技术论坛 : <%=title%> ...</title>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr valign="top">
            <td width="99%"><p class="jive-breadcrumbs"><a href="http://bbs.chinajavaworld.com/index.jspa">首页</a> &#187;
                ...
                <p class="jive-page-title"> 主题: <%=title%>
                </p></td>
            <td width="1%">
    ...
    <div class="jive-buttons">
        <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="jive-icon-label"><a id="jive-reply-thread" href="reply.jsp?id=<%=id%>">回复本主题</a></td>
            </tr>
            </tbody>
        </table>
    </div>
                        ...
                        <div class="jive-table">
                            <div class="jive-messagebox">
                                <table summary="Message" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="150">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img class="jive-avatar" src="images/avatar-display.png" alt=""
                                                             border="0"> <br>
                                                        <br>
                                  ...
                                  注册:
                                  07-5-10 <br>
                                  <a href="http://blog.chinajavaworld.com/u/215489" target="_blank"><font color="red">访问我的Blog</font></a> </span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td colspan="4"
                                                        ...
                                                        ·<a href="http://www.bjsxt.com"><font color="#666666">http://www.bjsxt.com</font></a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
